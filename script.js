...
function nixonInfo(event) {
    ...
    candidateInfo(event, `This is Richard Nixon, the most incredible presidential candidate to ever run! It should be obvious why you should vote for him, but in case you can't figure it out, we gave some reasons for you!`, ["Great leader","Good speaker", "Great hair","Etcetera"]);
}
...
function mcgovernInfo(event) {
    event.preventDefault();
    candidateInfo(event, `This is George McGovern. Frankly I'm not really sure why you're looking for info on this guy. Don't vote for him.`,["He's an inept leader","Terrible speaker","Hair's not even that good","All in all just no good"]);
}
